...
def run_phase3_resume(job_file: Path, target_role: str = "", save_prefix: str = "resume_output") -> dict:
    ...
    json_path = settings.phase3_output_dir / f"{save_prefix}_{timestamp}.json"
    tex_path = settings.phase3_output_dir / f"{save_prefix}_{timestamp}.tex"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--save-prefix", type=str, default="resume_output")
